...
EQB_HOMOTOPY="${EQB_HOMOTOPY:-true}"
EQB_HOMOTOPY_INITIAL_DMU="${EQB_HOMOTOPY_INITIAL_DMU:-0.1}"
EQB_HOMOTOPY_MIN_DMU="${EQB_HOMOTOPY_MIN_DMU:-0.001}"
EQB_HOMOTOPY_MAX_DMU="${EQB_HOMOTOPY_MAX_DMU:-0.2}"
EQB_HOMOTOPY_GROWTH="${EQB_HOMOTOPY_GROWTH:-1.4}"
EQB_HOMOTOPY_SHRINK="${EQB_HOMOTOPY_SHRINK:-0.5}"
EQB_HOMOTOPY_MAX_FAILURES="${EQB_HOMOTOPY_MAX_FAILURES:-20}"
...
Common env vars:
  ...
  EQB_HOMOTOPY=true          residual homotopy fallback for ODE promotion
  EQB_HOMOTOPY_INITIAL_DMU=0.1
  EQB_HOMOTOPY_MIN_DMU=0.001
...
echo "  homotopy=${EQB_HOMOTOPY} dmu=${EQB_HOMOTOPY_INITIAL_DMU} min_dmu=${EQB_HOMOTOPY_MIN_DMU}"
...
if has_phase "discover"; then
  discover_cmd=(
    ...
    "EQB_HOMOTOPY=${EQB_HOMOTOPY}"
    "EQB_HOMOTOPY_INITIAL_DMU=${EQB_HOMOTOPY_INITIAL_DMU}"
    "EQB_HOMOTOPY_MIN_DMU=${EQB_HOMOTOPY_MIN_DMU}"
    "EQB_HOMOTOPY_MAX_DMU=${EQB_HOMOTOPY_MAX_DMU}"
    "EQB_HOMOTOPY_GROWTH=${EQB_HOMOTOPY_GROWTH}"
    "EQB_HOMOTOPY_SHRINK=${EQB_HOMOTOPY_SHRINK}"
    "EQB_HOMOTOPY_MAX_FAILURES=${EQB_HOMOTOPY_MAX_FAILURES}"
